...
import { FaHome, FaShieldAlt, FaCalendarAlt, FaQuestionCircle, FaCog, FaSignOutAlt, FaFutbol, FaTimes, FaChartBar,  FaTrophy } from "react-icons/fa";
  ...
  return (
    <>
      ...
      <aside
        ...
        className={`fixed top-0 left-0 h-full w-64 bg-green-500/80 text-white flex flex-col py-6 px-2 z-40 transform transition-transform duration-300 ease-in-out lg:translate-x-0 ${
      ...
      >
        ...
        */}
        <nav className="flex-grow flex flex-col space-y-2">
          ...
          <SidebarNavLink to="/leaderboard" icon={< FaTrophy size={20} />} text="Leaderboard" />
        </nav>
